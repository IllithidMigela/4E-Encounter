...
<div className="gl-line">
      ...
      <div className="gl-line surge-line">
        <span className="gl-line-label" data-role="surge-label">回复力</span>
        <span className="gl-surge-num"><b>{surgesCur}</b> / {d.surges}</span>
        <FilledButton className="gl-md-btn gl-btn-sm" disabled={surgesCur <= 0} onClick={() => spendSurge(false)} title={surgeTemp !== 0 ? "回复值 " + d.surgeValue + " ＋临时 " + fmtMod(surgeTemp) : "回复值 " + d.surgeValue}>
          回复 ＋{healPerSurge}
        </FilledButton>
        ...
        <span className="gl-line-label" data-role="surge-temp-label">临时回复值</span>
